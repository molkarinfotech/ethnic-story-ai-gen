    ...
    <div style={{ minHeight: '100dvh', background: '#fdf2f8', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{
        ...
        <a
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '.5rem', textDecoration: 'none', minWidth: 0, flexShrink: 1, overflow: 'hidden' }}
        >
          <img
            src="/logo.jpg"
            alt="Ethnic Story"
          ...
          return (
            <a
              ...
              style={{
                ...
                fontSize: '.5rem', fontWeight: active ? 700 : 500,
                gap: '.1rem',
